...
Pipeline simples de engenharia de dados em Python que coleta eventos públicos da GitHub API,
armazena dados brutos, normaliza as informações e carrega os dados em um banco SQLite para análise.
...
- src/ingest_github.py — ingestão da API
- src/transform.py — normalização dos dados
- src/load_sqlite.py — carga no banco
- src/settings.py — configurações
